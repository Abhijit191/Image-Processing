...
while True:
    successful_frame_read, frame = webcame.read()
    ...
    faces = face_classifier.detectMultiScale(frame_grayscale)
    ...
    for (x, y, w, h) in faces:
        ...
        smiles = smile_classifier.detectMultiScale(frame_grayscale, 
